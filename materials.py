# Materials
#
# Materials definitions for the problem set

import numpy as np
from diffusion.material import Material

data = np.array([
	[1.43, 0.37, 0.0079, 0.0600, 0.0200, 0.0034, 0.0750],
	[1.43, 0.37, 0.0084, 0.0750, 0.0190, 0.0054, 0.1010],
	[1.43, 0.37, 0.0089, 0.0850, 0.0180, 0.0054, 0.1010],
	[1.43, 0.37, 0.0088, 0.0850, 0.0190, 0.0062, 0.1249],
	[1.26, 0.27, 0.0025, 0.0200, 0.0300, 0,      0],
	[1.00, 0.34, 0.0054, 0.1500, 0.0010, 0,      0],
